...
This folder defines all source code for the 'dlt-sales-pipeline' pipeline:
...
* Take a look at the sample under "sample_users_dlt_sales_pipeline.py" to get familiar with the syntax.
